 ...
 */
final class Version20220607094504 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD episode_id_id INT DEFAULT NULL, DROP episode_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD episode_id INT NOT NULL, DROP episode_id_id');
    }
}
